...
<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
	<div class="container">
		...
		<div class="footer-bottom-wrap">
			<div class=".col-sm-4 .col-md-4 .col-lg-5 .col-xl-5 .col-xs-12"></div>
			<div class=".col-sm-4 .col-md-4 .col-lg-4 .col-xl-4 .col-xs-12">
			...
			<div class=".col-sm-4 .col-md-4 .col-lg-3 .col-xl-3 .col-xs-12">
